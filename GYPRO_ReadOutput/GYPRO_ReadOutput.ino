...
void loop() {    
    ...
    if (dataReady) {
        ...
        Rate = (long)sensorOutputBuffer[0];              // Bitmask and bitshift to determine Acceleration
        ...
        ARDUINO_OUTPUT.print(float(Rate / 256) / 10000, 3); // Send outputs
